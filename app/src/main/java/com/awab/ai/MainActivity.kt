...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chatContainer = LinearLayout(this).apply {
            ...
            setPadding(16, 48, 16, 16)  // Extra top padding for status bar
        }
